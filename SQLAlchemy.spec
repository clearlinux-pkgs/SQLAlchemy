...
Source0  : https://files.pythonhosted.org/packages/4a/38/312ffbd98c204c4bf28293a3dd4a263579f558bef01ae1b5d81672a3adec/SQLAlchemy-1.4.2.tar.gz
Source1  : https://files.pythonhosted.org/packages/4a/38/312ffbd98c204c4bf28293a3dd4a263579f558bef01ae1b5d81672a3adec/SQLAlchemy-1.4.2.tar.gz.asc
...
%prep
%setup -q -n SQLAlchemy-1.4.2
cd %{_builddir}/SQLAlchemy-1.4.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1616432956
...
cp %{_builddir}/SQLAlchemy-1.4.2/LICENSE %{buildroot}/usr/share/package-licenses/SQLAlchemy/eefb00d4476c9b701ca0d16d96de0df3cac2c35a
